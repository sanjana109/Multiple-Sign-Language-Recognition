...
from tkinter import GROOVE, Entry, Label, OptionMenu, StringVar
...
class Main:
    def __init__(self):
        ...
        self.Tsub.config(text="Signs & Words, understand it all...",
                         font=("Garamond", 25, "italic"))
        self.panel4 = tk.Label(self.root, justify="center")

        self.btasl = tk.Button(
            self.root, command=self.action_asl, height=0, width=0)
        self.btasl.config(
            text="Recognise American Sign Language (ASL)", font=("Cambria", 15))
        self.btasl.place(x=300, y=200)

        self.btisl = tk.Button(
            self.root, command=self.action_isl, height=0, width=0, justify="center")
        self.btisl.config(
            text="Recognise Indian Sign Language (ISL)", font=("Cambria", 15))
        self.btisl.place(x=315, y=300)

        self.btsplt = tk.Button(
            self.root, command=self.action_splt, height=0, width=0)
        self.btsplt.config(text="Spoken Language Translate",
                           font=("Cambria", 15))
        self.btsplt.place(x=350, y=400)

        self.bttiasl = tk.Button(
            self.root, command=self.action_tiasl, height=0, width=0)
        self.bttiasl.config(text="Text to Image ASL", font=("Cambria", 15))
        self.bttiasl.place(x=400, y=500)

        self.bttiisl = tk.Button(
            self.root, command=self.action_tiisl, height=0, width=0)
    ...
    def action_asl(self):
        ...
        self.json_file = open(self.directory+"//model-asl.json", "r")
        self.model_json = self.json_file.read()
        self.json_file.close()
        self.loaded_model = model_from_json(self.model_json)
        self.loaded_model.load_weights(self.directory+"//model-asl-weights.h5")
        ...
        self.T.config(text="American Sign Language to Text",
        ...
        self.bt1 = tk.Button(
            self.root1, command=self.action1, height=0, width=0)
        self.bt1.place(x=26, y=890)
        self.bt2 = tk.Button(
            self.root1, command=self.action2, height=0, width=0)
        self.bt2.place(x=325, y=890)
        self.bt3 = tk.Button(
            self.root1, command=self.action3, height=0, width=0)
        self.bt3.place(x=625, y=890)
        self.bt4 = tk.Button(
            self.root1, command=self.action4, height=0, width=0)
        self.bt4.place(x=125, y=950)
        self.bt5 = tk.Button(
            self.root1, command=self.action5, height=0, width=0)
    ...
    def action_isl(self):
        ...
        self.json_file = open(self.directory+"//model-isl.json", "r")
        self.model_json = self.json_file.read()
        self.json_file.close()
        self.loaded_model = model_from_json(self.model_json)
        self.loaded_model.load_weights(self.directory+"//model-isl-weights.h5")
        ...
        self.T.place(x=31, y=17)
        self.T.config(text="Indian Sign Language to Text",
                      font=("Cambria", 40, "bold"))
        ...
        self.bt1 = tk.Button(
            self.root2, command=self.action1, height=0, width=0)
        self.bt1.place(x=26, y=890)
        self.bt2 = tk.Button(
            self.root2, command=self.action2, height=0, width=0)
        self.bt2.place(x=325, y=890)
        self.bt3 = tk.Button(
            self.root2, command=self.action3, height=0, width=0)
        self.bt3.place(x=625, y=890)
        self.bt4 = tk.Button(
            self.root2, command=self.action4, height=0, width=0)
        self.bt4.place(x=125, y=950)
        self.bt5 = tk.Button(
            self.root2, command=self.action5, height=0, width=0)
        self.bt5.place(x=425, y=950)
        self.str = ""
        self.word = ""
        self.current_symbol = "Empty"
    ...
    def action_splt(self):
        ...
        self.Tname.config(text="Spoken Language Translation",
                          font=("Garamond", 20, "bold", "italic"))
        self.panel3 = tk.Label(self.root3, justify="center")

        self.sourceLang = tk.Label(
            self.root3, text="Source Language", font=("Cambria", 15, "underline"))
        self.sourceLang.place(x=190, y=175)
        self.InputLanguageChoiceMenu = tk.OptionMenu(
            self.root3, InputLanguageChoice, *LanguageChoices)
        self.InputLanguageChoiceMenu.place(x=230, y=210)

        # choice in which the language is to be translated
        self.targetLang = tk.Label(
            self.root3, text="Translated Language", font=("Cambria", 15, "underline"))
        self.targetLang.place(x=585, y=175)
        self.NewLanguageChoiceMenu = tk.OptionMenu(
            self.root3, TranslateLanguageChoice, *LanguageChoices)
        self.NewLanguageChoiceMenu.place(x=630, y=210)

        self.input = tk.Label(
            self.root3, text="Enter Text", font=("Cambria", 13))
        ...
        self.output = tk.Label(
            self.root3, text="Output Text", font=("Cambria", 13))
        ...
        self.bttr = tk.Button(self.root3, text="Translate", font=("Cambria", 15), command=lambda: self.Translate(
            InputLanguageChoice.get(), TranslateLanguageChoice.get(), TextVar.get(), OutputVar), relief=GROOVE)
    ...
    def action_tiasl(self):
        ...
        self.Tname.place(x=25, y=105, width=900, height=45)
        self.Tname.config(text="Text to American Sign Language Translation", font=(
            "Garamond", 20, "bold", "italic"))
        self.panel3 = tk.Label(self.root4, justify="center")

        self.InputLabel = tk.Label(
            self.root4, text="Enter Text", font=("Cambria", 13))
        ...
        self.bttiasl = tk.Button(self.root4, text="Translate", font=(
            "Cambria", 15), command=lambda: self.TextToImage(TextVar, 0), relief=GROOVE)
    ...
    def action_tiisl(self):
        ...
        self.Tname.place(x=25, y=105, width=900, height=45)
        self.Tname.config(text="Text to Indian Sign Language Translation", font=(
            "Garamond", 20, "bold", "italic"))
        self.panel3 = tk.Label(self.root5, justify="center")

        self.InputLabel = tk.Label(
            self.root5, text="Enter Text", font=("Cambria", 13))
        self.InputLabel.place(x=300, y=200)
        ...
        self.bttiisl = tk.Button(self.root5, text="Translate", font=(
            "Cambria", 15), command=lambda: self.TextToImage(TextVar, 1), relief=GROOVE)
    ...
    def action_call(self):
        ...
        self.tx.config(text="Sanjana N", fg="blue",
                       font=("Times", 20, "italic"))

        self.tx = tk.Label(self.root6)
        self.tx.place(x=550, y=100)
        self.tx.config(text="1RV19CS137", fg="green",
                       font=("Times", 20, "italic"))

        self.tx = tk.Label(self.root6)
        self.tx.place(x=150, y=150)
        self.tx.config(text="Sharayu Badiger", fg="blue",
                       font=("Times", 20, "italic"))

        self.tx = tk.Label(self.root6)
        self.tx.place(x=550, y=150)
        self.tx.config(text="1RV19CS145", fg="green",
                       font=("Times", 20, "italic"))
    ...
    def TextToImage(ssd, TextVar, lang):
        ...
        for i in imgseq:
            ...
            if ind == 0:
                ...
                img = cv2.imread(i)
                imgs = np.array([fimg, img])
                fimg = np.concatenate([imgs], axis=0)
